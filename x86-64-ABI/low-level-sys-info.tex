...
\Hrule
  ...
  \begin{center}
    \begin{tabular}{l|p{8cm}|l}
      ...
      \hline
      \noalign{\smallskip}
\RAX & temporary register; used also for variable arguments to pass
information about the number of SSE registers used  & No \\
\RBX & callee-saved register & Yes \\
\RCX & used to pass 4$^{\rm th}$ integer argument to functions & No \\
\RDX & used to pass 3$^{\rm rd}$ argument to functions & No \\
