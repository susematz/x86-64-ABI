...
\reg{r11} through \reg{r15} ``belong'' to the calling function and the
...
\reg{r9}.  \footnote{Note that \reg{r10} is required to
  be preserved, nor is used to pass arguments.  Making this
