...
shall not be modified by signal or interrupt
...
frame, rather than ajdusting the stack pointer in the prologue and
epilogue.
...
\footnote{Note that \reg{r8} and \reg{r9} are not required to be
