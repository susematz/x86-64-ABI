...
register, taken in the order \RBX, \RCX, \RDX, \RSI, \RDI, and \reg{r8}.
\footnote{Note that \RAX and \reg{r9} are not required to be
...
and of type \code{__m128}, are placed in the next available SSE
register, taken in order from \reg{xmm0} to \reg{xmm15}.  If no
...
In this case, the function also sets \RBX to the value of the original
