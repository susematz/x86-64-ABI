...
\Hrule
  ...
  \begin{center}
    \begin{tabular}[t]{l|l}
      ...
      \hline
      \texttt{SHF_AMD64_LARGE} & \texttt{0x10000000}
    \end{tabular}
  \end{center}
\Hrule
\end{table}
...
\begin{description}
 \item[\code{SHF\_AMD64\_LARGE}] If an object file section does
   {\em not} have
  ...
  \begin{center}
    \begin{tabular}[t]{l|l|l}
      ...
      \texttt{.lbss} & \texttt{SHT_NOBITS} &
         \texttt{SHF_ALLOC+SHF_WRITE+SHF_AMD64_LARGE} \\
      ...
      \texttt{.lplt} & \texttt{SHT_PROGBITS} &
         \texttt{SHF_ALLOC+SHF_EXECINSTR+SHF_AMD64_LARGE} \\
      \texttt{.lrodata} & \texttt{SHT_PROGBITS} &
         \texttt{SHF_ALLOC+SHF_AMD64_LARGE} \\
...
an ELF section(s) of type \code{SHT_AMD64_UNWIND}. In the simplest case there
