...
\begin{center}
  \begin{picture}(360,190)
    \put(0,150){\framebox(50, 33){8\hfill\textit{word8}\hfill 0}}
    \put(0,100){\framebox(90, 33){16\hfill\textit{word16}\hfill 0}}
...
\Hrule
  ...
  \begin{center}
    \begin{tabular}[t]{l|r|l|l}
      ...
      \texttt{R_X86_64_PLT64} & 4 & \textit{word64} & \texttt{L + A - P} \\
      \texttt{R_X86_64_COPY}  & 5 & none            & none \\
      \texttt{R_X86_64_GLOB_DAT} & 6 & \textit{word64} & \texttt{S} \\
      \texttt{R_X86_64_JMP_SLOT} & 7 & \textit{word64} & \texttt{S} \\
