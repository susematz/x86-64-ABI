...
\Hrule
  ...
  \begin{center}
    \begin{tabular}[t]{l|r|l|l}
      ...
      \texttt{R_X8664_32}    & 10 & \textit{word32} & \texttt{S + A} \\
      \texttt{R_X8664_32S}   & 11 & \textit{word32} & \texttt{S + A} \\
    \end{tabular}
  \end{center}
\Hrule
\end{figure}
...
\begin{sloppypar}
The \texttt{R_X8664_32} and \texttt{R_X8664_32S} relocations truncate
the computed value to 32-bits.  The linker must verify that the
generated value for the \texttt{R_X8664_32} (\texttt{R_X8664_32S})
