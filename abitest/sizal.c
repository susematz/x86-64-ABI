 ...
 *
 * At a later point this test will be autogenerated to make a very exhaustive
 * test. For now this just tests the basic types.
 */
...
/* FIXME: GCC don't make alignment = 16 of arrays with size >= 16.  */
...
/* Check size of a struct of three types.  */
#define check_struct3(_type1, _type2, _type3, _size) { \
...
/* TODO: Reinsert these when gcc can handle them
