...
struct long_struct { long l; };
struct long2_struct { long l1, l2; };
...
/* This is partly disabled because of a gcc bug.  */
void
...
test_mixed_passing (void)
{
    ...
    clear_registers; check_mixed_passing1(8, is, 9);
    clear_registers; check_mixed_passing2(10, l3s, 11);
}
