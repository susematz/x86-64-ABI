...
void
check_hardware_registers1 (int i0)
{
  check_register_contents;
}

void
check_hardware_registers2 (int i1, int i0)
{
  check_register_contents;
}

void
check_hardware_registers3 (char i1, int i0)
{
  check_register_contents;
}

void
check_hardware_registers4 (int i2, short i1, int i0)
{
  check_register_contents;
}

void
check_hardware_registers5 (long i4, long i3, long i2, int i1, int i0)
{
  check_register_contents;
}

void
check_hardware_registers6 (long i5, long i4, int i3, long i2, int i1, int i0)
{
  check_register_contents;
}
