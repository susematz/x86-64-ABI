...
#ifdef CHECK_INT128
  check_basic_union_size_and_align(__int128, TYPE_SIZE_INT128, TYPE_ALIGN_INT128);
  check_basic_union_size_and_align(__uint128, TYPE_SIZE_INT128, TYPE_ALIGN_INT128);
#endif
